...
class UnetGenerator(nn.Module):
    def __init__(self, in_channels, out_channels, num_downs, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False):
        ...
        unet_block = UnetSkipConnectionBlock(ngf * 8, ngf * 8, in_channels=None, submodule=None, norm_layer=norm_layer, innermost=True)  # add the innermost layer
        ...
        self.model = UnetSkipConnectionBlock(out_channels, ngf, in_channels=in_channels, submodule=unet_block, outermost=True, norm_layer=norm_layer)  # add the outermost layer
